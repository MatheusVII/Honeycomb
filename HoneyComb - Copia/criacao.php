...
<body>
    <div class="voltar">
        <h2>Curso de Criação de Abelhas Nativas sem Ferrão - Uruçu, Mandaçaia, Jataí e Iraí</h2>
        <a href="cursos.php" class="btn btn-danger btn-lg" style="height:3rem; margin:2rem">Voltar</a>
    </div>
  <section class="video">
        <video src="videos/urucu.mp4" width="50%" controls></video>
  </section>
  ...
  <section class="final">
    ...
    <div class="capacidades">
        <div class="container">
            <p>Produzir mel de alta qualidade com segurança, utilizando abelhas sem ferrão</p>
        </div>
        <div class="container">
            <p>Conhecer a anatomia e as diferenças das abelhas nativas Uruçu, Mandaçaia, Jataí e Iraí</p>
        </div>
        <div class="container">
            <p>Obter enxames de abelhas e fazer a transferência de um ninho natural para a colmeia</p>
        </div>
        <div class="container">
            <p>Realizar o manejo correto de colônias de abelhas</p>
        </div>
        <div class="container">
            <p>Colher e processar o mel de forma segura e aproveitar ao máximo a capacidade produtiva</p>
        </div>
        <div class="container">
            <p>Comercializar e obter renda com a produção de mel</p>
        </div>
    </div>
    <footer>
